        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`cursor-pointer rounded-lg px-4 py-2 ${activeMenu === "dashboard"
                ? "bg-gray-200"
                : "hover:bg-gray-100"
                }`}
            >
            ...
            <button
              ...
              className={`cursor-pointer rounded-lg px-4 py-2 ${activeMenu === "users"
                ? "bg-gray-200"
                : "hover:bg-gray-100"
                }`}
            >
            ...
            <button
              ...
              className={`cursor-pointer rounded-lg px-4 py-2 ${activeMenu === "teacher"
                ? "bg-gray-200"
                : "hover:bg-gray-100"
                }`}
            >
            ...
            <button
              ...
              className={`cursor-pointer rounded-lg px-4 py-2 ${activeMenu === "settings"
                ? "bg-gray-200"
                : "hover:bg-gray-100"
                }`}
            >
            ...
            <button
              ...
              className="cursor-pointer ml-3 rounded-lg bg-red-600 px-4 py-2 text-white hover:bg-red-700"
            >
              Logout
            </button>
